...
class NaturalPG(PolicyGradient):
    ...
    _fvp_original_obs: torch.Tensor
    ...
    def _fvp(self, params: torch.Tensor) -> torch.Tensor:
        ...
        q_dist = self._actor_critic.actor(self._fvp_obs, original_obs=self._fvp_original_obs)
        with torch.no_grad():
            p_dist = self._actor_critic.actor(self._fvp_obs, original_obs=self._fvp_original_obs)
    ...
    def _update_actor(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        self._fvp_original_obs = original_obs[:: self._cfgs.algo_cfgs.fvp_sample_freq]
    ...
    def _update(self) -> None:
        ...
        self._update_actor(obs, act, logp, adv_r, adv_c, original_obs)

        dataloader = DataLoader(
            dataset=TensorDataset(obs, target_value_r, target_value_c, original_obs),
