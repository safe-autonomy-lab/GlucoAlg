...
class Actor(nn.Module, ABC):
    ...
    def __init__(
        ...
        if isinstance(self._obs_space, spaces.Box) and len(self._obs_space.shape) == 1:
            ...
            self._obs_dim: int = self._feature_dim
        else:
        ...
        if isinstance(self._act_space, spaces.Box) and len(self._act_space.shape) == 1:
            ...
            self._act_dim: int = len(self._act_space.nvec)
        else:
            raise NotImplementedError(f"Action space {type(self._act_space)} not supported")
...
class Critic(nn.Module, ABC):
    ...
    def __init__(
        ...
        if isinstance(self._obs_space, spaces.Box) and len(self._obs_space.shape) == 1:
            ...
            self._obs_dim = self._feature_dim
        else:
            raise NotImplementedError
        ...
        if isinstance(self._act_space, spaces.Box) and len(self._act_space.shape) == 1:
            ...
            self._act_dim = len(self._act_space.nvec)
        else:
            raise NotImplementedError(f"Action space {type(self._act_space)} not supported")
