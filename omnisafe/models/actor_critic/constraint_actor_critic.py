...
class ConstraintActorCritic(ActorCritic):
    ...
    def __init__(
        ...
        super().__init__(obs_space, act_space, model_cfgs, epochs, shield_type)
    ...
    def step(
        ...
        original_obs: torch.Tensor = None,
    ) -> tuple[torch.Tensor, ...]:
        ...
        with torch.no_grad():
            ...
            action = self.actor.predict(obs, deterministic=deterministic, original_obs=original_obs)
    ...
    def forward(
        ...
        Returns:
            ...
            log_prob: The log probability of the action.
        """
        return self.step(obs, deterministic=deterministic, original_obs=original_obs)
