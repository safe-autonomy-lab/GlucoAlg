...
class VectorShieldedOnPolicyBuffer(ShieldedOnPolicyBuffer):
    ...
    def __init__(  # pylint: disable=super-init-not-called,too-many-arguments
        ...
        self.buffers: list[ShieldedOnPolicyBuffer] = [
    ...
    def finish_path(
        ...
        """
        self.buffers[idx].finish_path(last_value_r, last_value_c, last_value_shield_violation)
